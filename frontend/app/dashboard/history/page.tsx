  ...
  return (
    <div className="h-full w-full bg-white dark:bg-[#121212] text-black font-sans flex flex-col overflow-y-auto custom-scrollbar">
      ...
      <div className="flex-1 p-8 bg-slate-50 dark:bg-[#1a1a1a]">
        <div className="border border-slate-100 dark:border-[#2a2a2a] bg-white dark:bg-[#121212] shadow-sm rounded-2xl overflow-hidden">
          <div className="bg-slate-50 dark:bg-[#1a1a1a] px-5 py-3 flex items-center justify-between border-b border-slate-100 dark:border-[#2a2a2a]">
              ...
              <table className="w-full text-sm text-left">
                <thead className="bg-slate-50 dark:bg-[#1a1a1a] border-b border-slate-100 dark:border-[#2a2a2a] text-xs font-semibold text-slate-500 dark:text-slate-400 dark:text-slate-500 dark:text-slate-400 dark:text-slate-500">
                  <tr>
                    ...
                    <th className="px-5 py-3 border-r border-slate-100 dark:border-[#2a2a2a] font-semibold">Status</th>
                    <th className="px-5 py-3 border-r border-slate-100 dark:border-[#2a2a2a] font-semibold text-right">Best Score</th>
                    <th className="px-5 py-3 border-r border-slate-100 dark:border-[#2a2a2a] font-semibold text-right">Duration</th>
                    ...
                    <tr key={run.id} className="hover:bg-slate-50 dark:bg-[#1a1a1a] transition-colors group">
                      ...
                      <td className="px-5 py-4 border-r border-slate-100 dark:border-[#2a2a2a]">
                        <span className={`px-2 py-1 rounded-md text-xs font-bold ${
                          ...
                          run.status === 'failed' ? 'bg-red-50 dark:bg-red-900/20 text-red-700' : 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700'
                        }`}>
                      ...
                      <td className="px-5 py-4 text-center">
                        <div className="flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button 
                            ...
                            className="p-1.5 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 hover:bg-indigo-100 hover:text-indigo-700 rounded-md transition-colors"
