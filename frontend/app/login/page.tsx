...
import { BrainCircuit, Mail, Loader2, ArrowRight, ShieldCheck, User, Lock, KeyRound, Eye, EyeOff } from 'lucide-react';
          ...
          {step === 'login' && (
            <div>
              <button
                ...
                className="w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-slate-200 rounded-xl shadow-sm text-sm font-bold text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 transition-all mb-6"
              >
