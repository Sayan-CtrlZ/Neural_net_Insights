    ...
    <div className="min-h-screen bg-transparent text-black dark:text-white selection:bg-indigo-500 selection:text-white font-sans overflow-hidden">
      ...
      <nav className="border-b border-slate-100 dark:border-white/20 px-8 py-5 flex justify-between items-center bg-white/70 dark:bg-black/70 backdrop-blur-xl sticky top-0 z-50">
        ...
        >
          ...
          <ThemeToggle />
          <Link href="/login" className="bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-5 py-2.5 rounded-full hover:bg-slate-800 dark:hover:bg-slate-200 shadow-xl shadow-slate-900/20 hover:shadow-slate-900/40 transition-all flex items-center gap-2 hover:scale-105 active:scale-95 font-bold">
      ...
      <main className="relative z-10">
        ...
        <section className="max-w-6xl mx-auto px-8 pt-32 pb-40 md:pt-48 md:pb-56 flex flex-col items-center text-center relative">
          ...
          >
            ...
            <motion.h1 variants={fadeIn} className="text-5xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tight mb-8 leading-[1.05] text-slate-900 dark:text-white drop-shadow-sm">
        ...
        {/* CTA Banner */}
        <section className="px-8 pb-32 bg-transparent">
          <motion.div 
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <Link 
                href="/login"
                className="bg-white dark:bg-[#121212] text-slate-900 dark:text-white px-10 py-4 rounded-full text-base font-bold hover:scale-105 shadow-xl shadow-white/10 hover:shadow-white/20 transition-all flex items-center gap-2 group"
              >
                Create Free Account
                <ArrowRight className="group-hover:translate-x-1 transition-transform" size={18} />
              </Link>
      ...
      <footer className="border-t border-slate-200 dark:border-white/20 py-12 px-8 bg-transparent relative z-10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center text-sm text-slate-500 dark:text-white/60">
          ...
          <p>&copy; {new Date().getFullYear()} Sayan. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
